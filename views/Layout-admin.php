	...
	<nav class="navbar navbar-default">
		<div class="container-fluid ">
        	...
        	<ul class="nav navbar-nav navbar-left">
                <li><a href=<?php echo dirname($_SERVER['PHP_SELF']).'/'?>><b>&lt;&lt;users</b></a></li>
            </ul>
        	<!-- Collect the nav links, forms, and other content for toggling -->
        	<div class="collapse navbar-collapse" id="navbar-collapse-1">
        		<ul class="nav navbar-nav navbar-right">
        			<p class="navbar-text">Hello,
        				<a href=<?php echo dirname($_SERVER['PHP_SELF']).'/admin/getacts'?> class="navbar-link"><?php echo constant('GA_USER')?></a>
        			</p>
        			<li><a href=<?php echo dirname($_SERVER['PHP_SELF']).'/logout'?>>logout</a></li>
        		</ul>
        	</div>
        </div>
    </nav>
